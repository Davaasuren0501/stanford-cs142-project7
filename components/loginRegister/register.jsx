...
class Register extends React.Component {
  constructor(props) {
    ...
    this.handleChangeBound8 = (event) =>
      this.handleChangeConfirmedPassword(event);
  ...
  showErrorMessageForPassword() {
    if (this.state.isPasswordDifferent === true) {
      var errorMessageForPassword = (
        <span style={{ color: "red" }}>
          **Password and confirmed password must be the same. Please try
          again.**
        </span>
      );
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <label>
          Note:
          <i>
            Please make sure that your password and confirmed password are
            identical.
          </i>
          <br />
        ...
        <input
          type="text"
          onChange={this.handleChangeBound2}
          id="myFirstName"
        />
        ...
        <input
          type="text"
          onChange={this.handleChangeBound5}
          id="myDescription"
        />
        ...
        <input
          type="text"
          onChange={this.handleChangeBound6}
          id="myOccupation"
        />
        ...
        <input
          type="password"
          onChange={this.handleChangeBound7}
          id="myPassword"
        />
        ...
        <input
          type="password"
          onChange={this.handleChangeBound8}
          id="myConfirmedPassword"
        />
